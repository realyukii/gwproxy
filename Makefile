...
ALL_TEST_TARGETS = $(LIBGWDNS_TEST_TARGET)
ALL_OBJECTS = $(GWPROXY_OBJECTS) $(LIBGWPSOCKS5_OBJECTS) $(LIBGWDNS_OBJECTS) $(LIBGWDNS_TEST_OBJECTS)
...
test: $(LIBGWDNS_TEST_TARGET)
	@echo "Running tests...";
	LD_LIBRARY_PATH=$(LD_LIBRARY_PATH):$(shell pwd) ./$(LIBGWDNS_TEST_TARGET);
